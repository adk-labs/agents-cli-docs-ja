...
<div class="hero-grid">
  <div class="hero-content">
    ...
    <p class="tagline">Google Cloud上でエージェントを構築するためのCLIおよびスキル。</p>
    <div class="home-cta">
      <a href="guide/getting-started/" class="cta-primary">はじめに &rarr;</a>
      <a href="https://github.com/google/agents-cli" class="cta-secondary" target="_blank" rel="noopener noreferrer">GitHubで表示</a>
    </div>
    <div class="works-with">
      <p class="works-with-text">お使いのコーディングエージェントと連携</p>
      <div class="works-with-logos">
        ...
        <span class="works-with-more">その他多数</span>
      </div>
    </div>
  </div>
  ...
  <div class="hero-side">
    <div class="raw-term install-card" data-copy="uvx google-agents-cli setup">
      ...
      <div class="raw-line"><span class="raw-comment"># CLIとスキルをインストール</span></div>
      ...
      <div class="raw-line"><span class="raw-comment"># コーディングエージェントに構築を依頼</span></div>
      <div class="raw-line"><span class="raw-prompt raw-prompt-user">&gt;</span> <span class="rotator" data-words='["インシデントを一次分類するエージェント","バグを追跡するエージェント","提案依頼書(RFP)を作成するエージェント","コードを監査するエージェント","毎日のブリーフィングを行うエージェント","市場を監視するエージェント"]'><span class="rotator-word">インシデントを一次分類するエージェント</span></span><span class="raw-cursor"></span></div>
    </div>
  </div>
</div>
